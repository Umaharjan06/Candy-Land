...
Partial Class frmCandyLandMain
    ...
    Friend WithEvents btn105 As Button
    Friend WithEvents btn104 As Button
    Friend WithEvents btn103 As Button
    Friend WithEvents btn102 As Button
    Friend WithEvents btn101 As Button
    Friend WithEvents btn110 As Button
    Friend WithEvents btn109 As Button
    Friend WithEvents btn108 As Button
    Friend WithEvents btn107 As Button
    Friend WithEvents btn106 As Button
    Friend WithEvents btn115 As Button
    Friend WithEvents btn114 As Button
    Friend WithEvents btn113 As Button
    Friend WithEvents btn112 As Button
    Friend WithEvents btn111 As Button
    Friend WithEvents btn120 As Button
    Friend WithEvents btn119 As Button
    Friend WithEvents btn117 As Button
    Friend WithEvents btn118 As Button
    Friend WithEvents btn116 As Button
    Friend WithEvents btn125 As Button
    Friend WithEvents btn124 As Button
    Friend WithEvents btn123 As Button
    Friend WithEvents btn122 As Button
    Friend WithEvents btn121 As Button
    Friend WithEvents btn130 As Button
    Friend WithEvents btn129 As Button
    Friend WithEvents btn128 As Button
    Friend WithEvents btn127 As Button
    Friend WithEvents btn126 As Button
    Friend WithEvents btn135 As Button
    Friend WithEvents btn134 As Button
    Friend WithEvents btn133 As Button
    Friend WithEvents btn132 As Button
    Friend WithEvents btn131 As Button
    Friend WithEvents btn140 As Button
    Friend WithEvents btn139 As Button
    Friend WithEvents btn138 As Button
    Friend WithEvents btn137 As Button
    Friend WithEvents btn136 As Button
    Friend WithEvents btn145 As Button
    Friend WithEvents btn144 As Button
    Friend WithEvents btn143 As Button
    Friend WithEvents btn142 As Button
    Friend WithEvents btn141 As Button
    Friend WithEvents btn149 As Button
    Friend WithEvents btn148 As Button
    Friend WithEvents btn147 As Button
    Friend WithEvents btn146 As Button
    ...
    Friend WithEvents btn150 As Button
    Friend WithEvents BtnStart As Button
    Friend WithEvents pnlMain As Panel
    Friend WithEvents Lblgivenumber As Label
